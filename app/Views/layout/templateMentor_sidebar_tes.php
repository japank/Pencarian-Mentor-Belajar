            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" style="background-color:#1a9bfc;color:white" href="<?= base_url(); ?>/exam/index" aria-expanded="false"><i class="mdi mdi-grease-pencil" style="color:white"></i><span class="hide-menu">Tes</span></a></li>
